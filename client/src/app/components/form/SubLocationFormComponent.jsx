...
function SubLocationFormComponent(props) {
    ...
    const [locationsOptions, setLocationsOptions] = useState([{ id: 0, name: "No Location" }]);
    ...
    useEffect(() => {
        ...
        if (typeof id !== "undefined" && id !== 0) {
            ...
            apiServiceV2.get(`v2/sublocations/${id}`).then(response => {
                ...
                apiServiceV2.get(`v2/locations?limit=50&tenant_id=${respSubLocation.tenant.id}`).then(response => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        location_id: Yup.number()
            .moreThan(0, "Location is required")
            .required("Location is required"),
        tenant_id: Yup.number()
            .moreThan(0, "Tenant is required")
    ...
    const save = (fields, { setFieldValue, setSubmitting }) => {
        ...
        sublocationService[endpoint](id, toSubmit).then(_response => {
                        ...
                        <form className="card card-custom" onSubmit={handleSubmit}>
                            ...
                            <div className={`card-header py-3 ` + classes.headerMarginTop}>
                                <div className="card-title align-items-start flex-column">
                                    <h3 className="card-label font-weight-bolder text-dark">SubLocation</h3>
                                ...
                                <div className="card-toolbar">
                                    {permissions.canEditSubLocations && (
                                        <button
                                            type="submit"
                                    ...
                                    <Link to="/sublocations/list" className="btn btn-secondary">
                                        Back to list
                                    </Link>
                                </div>
                            </div>
                                                    ...
                                                    onRowUpdate: (newData, oldData) =>
                                                        new Promise((resolve, _reject) => {
                                                            setTimeout(() => {
                                                                ...
                                                                const index = getGeofenceIndexById(
