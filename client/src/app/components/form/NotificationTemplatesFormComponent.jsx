                                                    ...
                                                    <div className='alert alert-secondary'>
                                                        <div className=''>
                                                            <span>
                                                                ...
                                                                %device_label% <b>Measurements variables</b>: %measurement_type% %measurement_value% <b>Threshold variables</b>: %threshold_name% %threshold_id% <b>Asset variables</b>: %asset_id% %asset_label% <b>Geofences variables</b>: %geofence_id% %geofence_label% %alert_status% <b>Shape variables</b>: %shape_id% %shape_label% <b>Geolocation variables</b>: %reverse_geocoding% %coordinates%
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
